...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      ?>
      <div class="alert alert-warning">You are about to remove this contact permanently. Do you want to continue?</div>
      <div>
        <a href="all_contacts.php" class="btn btn-success btn-lg active btn-block" role="button">No, don't remove the contact</a>
        <a href="libs/controller.php?a=remove&id=<?php echo $id; ?>" class="btn btn-danger btn-lg active btn-block" role="button">Yes, remove this contact permanently</a>
      </div>
      <br>
      <?php
